...
function Pot() {
  return (
    <div>
      <Header />
        <h2 className="titre bloc">Le pot de Charles-Quint à Walcourt</h2>
        <div className="corePot bloc">
          <img className="imgLeft" src="http://www.legende-beaumont.be/wpimages/wpf6bc746f_05_06.jpg"></img>
          <p>Le grand empereur Charles-Quint, en visite dans ses Provinces du Nord, s’arrêta dans une auberge à Walcourt (Province de Namur – Belgique), pour se désaltérer.</p>
          <p>
...
très intimidée par le prestigieux personnage, elle lui tendit le pot en le tenant par la anse.</p>
<p>
...
A quelques temps de là, de nouveau de passage à Walcourt, il fit halte dans l’auberge.</p>
<p>
...
<img className="imgRight" src="http://www.legende-beaumont.be/wpimages/wp92686306_06.png"></img>
